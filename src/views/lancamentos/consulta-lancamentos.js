...
class ConsultaLancamentos extends React.Component {
    ...
    deletar=()=>{
        this.service.deletar(this.state.lancamentoDeletar.id).then(response =>{
            ...
            messages.mensagemSucesso('Lancamento deletado com suceso')
        }).catch(erro=>{
                    ...
                    <div className="col-md-6">
                        <div className="bs-component">
                            ...
                            <FormGroup htmlFor="inputMes" label="Mês: ">
                                <SelectMenu value={this.state.mes}  onChange={e => this.setState({mes: e.target.value})} id="inputMes" className="form-control" lista={meses} />
                            </FormGroup>
